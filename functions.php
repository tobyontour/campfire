...
if ( ! function_exists( 'scout_group_theme_setup' ) ) :
	...
	function scout_group_theme_setup() {
		 ...
		 * to change 'scout-group-theme' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'scout-group-theme', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'scout-group-theme' ),
			)
		);
...
function scout_group_theme_widgets_init() {
	register_sidebar(
		array(
			...
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'scout-group-theme' ),
...
function scout_group_theme_scripts() {
	...
	wp_enqueue_script( 'scout-group-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
